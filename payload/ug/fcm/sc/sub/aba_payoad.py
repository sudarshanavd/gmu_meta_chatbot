...
def build_aba_program_payload(wa_id: str):
    ...
    body = MessageBody(
        text=(
            "🎓 *B.COM in AI and Business Analytics (ABA)*\n\n"
    ...
    btn_program_details = Button(reply=ButtonReply(id="abaca", title="Program Details"))
    btn_fee_duration = Button(reply=ButtonReply(id="abacb", title="Fee & Duration"))
    btn_branch_website = Button(reply=ButtonReply(id="abacc", title="Branch Website"))
...
def build_aba_program_details_payload(wa_id: str):
    ...
    text = (
        "🎓 *B.COM AI and Business Analytics (ABA)*\n"
